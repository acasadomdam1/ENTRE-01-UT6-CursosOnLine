...
public class Curso
{
    ...
    private String capitalizarNombre(String nombre) 
    {
        ...
        String[] spliteada = nombre.split(ESPACIO);
        
        for(int i = 0 ; i < spliteada.length ; i++)
        {
            sb.append(spliteada[i].substring(0, 1).toUpperCase());
            sb.append(spliteada[i].substring(1));
            
            if(i < spliteada.length - 1){
                sb.append(ESPACIO);
            }
        }
